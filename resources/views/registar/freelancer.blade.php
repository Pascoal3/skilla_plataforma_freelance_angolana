...
<header class="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-lg border-b border-slate-100">
    <nav class="flex justify-between items-center px-6 py-4 max-w-7xl mx-auto">
        <div class="text-2xl font-black text-slate-950 italic font-h1 tracking-tighter">
            <img id="logo_plataforma" src="{{ asset('img/logo_skilla8_invertido-removebg-preview.png') }}" alt="SKILLA" style="width: 80px; height: 80px;">
        </div>
        ...
        <div class="flex items-center gap-4">
            <a href="{{ route('registar.cliente') }}" class="font-bold text-sm font-label-caps hover:brightness-90 transition-all" style="color: black;">Aqui para contratar talentos? Junte-se como Cliente</a>
        </div>
    </nav>
</header>
...
<main class="min-h-screen pt-32 pb-20 flex flex-col items-center justify-start px-container-padding">
    <div class="w-full max-w-2xl text-center mb-12">
        <h1 class="font-h1 text-h2 md:text-h1 text-slate-950 mb-4">Cadastre-se para encontrar o trabalho que você ama.</h1>
        <p class="font-body-lg text-body-lg text-slate-500 max-w-md mx-auto">Junte-se a milhares de freelancers em Angola e encontre oportunidades que valorizam o seu talento.</p>
    </div>
        ...
        <form class="space-y-6" id="register-form" novalidate onsubmit="return false;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-grid-gutter">
                <div class="flex flex-col gap-2">
                    ...
                    <input class="w-full bg-slate-50 border-b-2 border-slate-200 focus:border-primary-container focus:ring-0 py-4 px-0 transition-all font-body-md text-slate-900 placeholder:text-slate-300" 
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="relative">
                    <input class="w-full bg-slate-50 border-b-2 border-slate-200 focus:border-primary-container focus:ring-0 py-4 px-0 transition-all font-body-md text-slate-900" 
                           type="email"/>
                </div>
            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="relative">
                    <input class="w-full bg-slate-50 border-b-2 border-slate-200 focus:border-primary-container focus:ring-0 py-4 px-0 transition-all font-body-md text-slate-900 placeholder:text-slate-300" 
                           ...
                           type="password"/>
                    <button class="absolute right-0 top-1/2 -translate-y-1/2 text-slate-400 hover:text-slate-600 transition-colors" 
                            type="button" 
                            id="toggle-password">
            ...
            <div class="flex flex-col gap-2">
                ...
                <select name="provincia_id" class="w-full bg-slate-50 border-b-2 border-slate-200 focus:border-primary-container focus:ring-0 py-4 px-0 transition-all font-body-md text-slate-900 appearance-none cursor-pointer">
...
<span class="material-symbols-outlined text-[16px]" style="display:hidden;">error</span>
            ...
            <div class="text-center pt-4">
                <p class="text-body-md text-slate-500">
                    Já tem uma conta? 
                    <a class="text-[#D6FF2A] font-bold hover:underline ml-1" href="#">Entrar</a>
                </p>
            </div>
        </form>
    </section>
...
<!-- Script do Freelancer -->
<script src="{{ asset('js/form_freelancer.js') }}"></script>
