...
<a href="{{ route('registar.freela') }}" class=" font-bold text-sm font-label-caps hover:brightness-90 transition-all" href="#" style="color: black;">Candidatar-se como talento</a>
</div>
</nav>
</header>
