...
<input checked="" class="w-5 h-5 rounded border-slate-300 focus:ring-primary-container/20 text-[#E6FF80]" type="checkbox">
</div>
<span class="text-body-md text-slate-600 leading-tight">Envie-me e-mails úteis para encontrar trabalhos recompensadores e leads de emprego</span>
</label>
<label class="flex items-start gap-3 cursor-pointer group">
<div class="relative flex items-center mt-1">
<input class="w-5 h-5 rounded border-slate-300 focus:ring-primary-container/20 text-[#E6FF80]" type="checkbox">
</div>
<span class="text-body-md text-slate-600 leading-tight">Sim, eu entendo e concordo com os <a class="hover:underline font-medium transition-all" href="#" style="color: rgb(225, 240, 177);">Termos de Serviço</a> do SKILLA, incluindo o Contrato do Usuário e a <a class="hover:underline font-medium transition-all" href="#" style="color: rgb(225, 240, 177);">Política de Privacidade</a>.</span>
</label>
</div>
<!-- CTA: Disabled State -->
<div class="pt-8">
...
<p class="text-body-md text-slate-500">
                        Já tem uma conta? <a class="font-bold hover:underline ml-1" href="#" style="color: rgb(225, 240, 177);">Entrar</a>
</p>
</div>
</form>
</section>
