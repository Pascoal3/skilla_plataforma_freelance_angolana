...
<head>
    ...
    <title>Skilla - Criar Conta Freelancer</title>
...
<main class="flex-grow flex items-center justify-center px-container-padding py-section-gap">
    <div class="max-w-2xl w-full">
        ...
        <div class="text-center mb-12">
            <h1 class="font-h2 text-h2 text-primary-fixed mb-4">Criar Conta Freelancer</h1>
            <p class="font-body-lg text-body-lg text-on-surface-variant">Ofereça seus serviços e conquiste clientes</p>
        </div>
        ...
        <div class="bg-surface-container rounded-xl border border-outline-variant p-card-padding space-y-6">
            <form id="register-form" class="space-y-6" novalidate>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select 
                        name="provincia_id"
                        class="w-full bg-surface-container-low border-b-2 border-outline-variant focus:border-primary-fixed focus:ring-0 py-4 px-0 transition-all font-body-md text-on-background appearance-none cursor-pointer"
                    >
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if(submitButton) {
    submitButton.addEventListener('click', async function(e) {
      ...
      formData.append('funcao', 'freelancer'); // ← FREELANCER
